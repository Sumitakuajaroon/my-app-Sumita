                ...
                <div className="bg-white items-center w-full md:max-w-7xl shadow-lg p-16 mb-5 bg-body rounded">
                    ...
                    <div className="grid grid-cols-2 my-3 text-center md:grid-cols-4">
                        <div className="flex flex-col leading-7 items-start ml-20">
                            ...
                            <p> <a className="text-gray-500/80 hover:text-cyan-600" href="#">AI ตรวจวินิจฉัยโลก</a> </p>
                            <p> <a className="text-gray-500/80 hover:text-cyan-600" href="#">AEC Ranking</a> </p>
                            <p> <a className="text-gray-500/80 hover:text-cyan-600" href="#">ChatGPT</a> </p>
                            <p> <a className="text-gray-500/80 hover:text-cyan-600" href="#">การประเมินนโยบายสาธารณะ</a> </p>
                        ...
                        <div className="flex flex-col leading-7">
                            ...
                            <p> <a className="text-gray-500/80 hover:text-cyan-600" href="#">การเรียนการสอน</a> </p>
                            <p> <a className="text-gray-500/80 hover:text-cyan-600" href="#">การวิจัย</a> </p>
                            <p> <a className="text-gray-500/80 hover:text-cyan-600" href="#">การบริการวิชาการ</a> </p>
                            <p> <a className="text-gray-500/80 hover:text-cyan-600" href="#">การทำนุบำรุงศิลปวัฒธรรม</a> </p>
                        ...
                        <div className="flex flex-col my-6 leading-7 md:my-0">
                            ...
                            <p> <a className="text-gray-500/80 hover:text-cyan-600" href="#">ข้อมูลส่วนบุคคล</a> </p>
                            <p> <a className="text-gray-500/80 hover:text-cyan-600" href="#">ความปลอดภัยทางไซเบอร์</a> </p>
                            <p> <a className="text-gray-500/80 hover:text-cyan-600" href="#">ยุทธศาสตร์ชาติ 20 ปี</a> </p>
                    ...
                    <div className="flex flex-col items-center m-5 md:flex-row md:justify-between md:mx-28"> <img
                        ...
                        <div className="mt-4 text-gray-500 font-semibold"> <a className="hover:text-blue-500 tracking-wide" href="#">DMCA
