    ...
    return (
        <div>
            <div className="flex justify-center ">
                <div className="flex flex-col justify-center items-center bg-slate-100 max-w-7xlshadow-lg p-16 mb-5 bg-body rounded ">
                    <div className="text-3xl text-green-600 font-bold mt-4 ">การวางเเผนเเละการบริหารนโยบายสาธารณะในยุคดิจิทัล</div>
                    ...
                    <div className="flex flex-col items-center justify-evenly my-12 lg:px-10 lg:flex-row space-y-8 lg:space-y-0 ">
                        <div
                            ...
                            <h1 className="text-xl tracking-tight font-semibold text-green-600 uppercase   ">1. Best Components</h1>
                            ...
                            <h1 className="text-lg font-semibold text-green-600 uppercase mt-1">mark warner</h1>
                        ...
                        <div
                            ...
                            <h1 className="text-xl tracking-tight font-semibold text-green-600 uppercase   ">2. Amazing Designs</h1>
                            <p className="text-black mt-3 text-center w-[90%] lg:w-[100%]"> Tailblocks provides best Tailwind CSS
                                Components and Blocks to create an unique websites within minutes. It has upto 60+ free
                                components for front-end Web Development.</p>
                            ...
                            <h1 className="text-lg font-semibold text-green-600 uppercase mt-1">alexa daniel</h1>
                            <h1 className="text-lg font-semibold text-black uppercase -mt-1">ceo / director</h1>
                        </div>
                        <div
                            className="flex flex-col justify-center items-center p-10 bg-white shadow w-[90%]  md:w-[70%] lg:w-[30%] overflow-hidden">
                            ...
                            <h1 className="text-xl tracking-tight font-semibold text-green-600 uppercase   ">3. Impressive</h1>
                            <p className="text-black mt-3 text-center w-[90%] lg:w-[100%]"> Tailblocks provides best Tailwind CSS
                                Components and Blocks to create an unique websites within minutes. It has upto 60+ free
                                components for front-end Web Development.</p>
                            ...
                            <h1 className="text-lg font-semibold text-green-600 uppercase mt-1">jessy bush</h1>
                            <h1 className="text-lg font-semibold text-black uppercase -mt-1">ceo / director</h1>
                        </div>
                    </div>
                </div>
